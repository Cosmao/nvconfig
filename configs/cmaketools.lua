local setup = {
  ...
  cmake_terminal = {
    ...
    opts = {
      name = "Main Terminal",
      prefix_name = "[CMakeTools Testing config]: ", -- This must be included and must be unique, otherwise the terminals will not work. Do not use a simple spacebar " ", or any generic name
